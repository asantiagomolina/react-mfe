...
const EFallback: React.FC = () => {
    ...
    return (
        <div className='flex flex-col h-dvh w-full bg-stone-800 text-white justify-center items-center'>
            <div className='mb-4'>
            ...
            <span className='mb-4 font-semibold'>Your page died, therefore try despair</span>
        </div>
    );
};
